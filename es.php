...
define('_ARTICLE',utf8_encode('Artículo'));
define('_ARTICLENOFOUND',utf8_encode('Artículo no encontrado'));
define('_ARTICLES',utf8_encode('Artículos'));
define('_ARTICLESNOFOUND',utf8_encode('No hay artículos!'));
define('_BACK',utf8_encode('Atrás'));
...
define('_FOOTER',utf8_encode('Pié'));
//define('_GOBACK',utf8_encode('<a href=\'javascript:history.go(-1)\'>'.'Volver atrás').'</a>'));
...
define('_INACTIVE',utf8_encode('Ináctivo'));
define('_INDEX',utf8_encode('Indice'));
define('_INFO',utf8_encode('Info'));
define('_INSERT',utf8_encode('Insertar'));
define('_INVALIDINFO',utf8_encode('Información inválida!'));
define('_INVALIDMAIL',utf8_encode('E-mail inválido!'));
define('_INVALIDPASS',utf8_encode('Contraseña inválida!'));
define('_INVALIDUSER',utf8_encode('Usuario inválido!'));
...
define('_MODULE',utf8_encode('Módulo'));
define('_MODULEADMIN',utf8_encode('Módulo ADMIN'));
...
define('_MODULENOFOUND',utf8_encode('El módulo no existe!'));
define('_MODULES',utf8_encode('Módulos'));
define('_MODULESADMIN',utf8_encode('Módulos \'ADMIN\''));
...
define('_OPTION',utf8_encode('Opción'));
define('_OS',utf8_encode('Sistemas Operativos'));
define('_OTHERS',utf8_encode('Otros'));
define('_PAGE',utf8_encode('Página'));
define('_PAGEGENERATION_SQL',utf8_encode('Página generada con'));
define('_PAGEGENERATION_TIME',utf8_encode('Página generada en'));
...
define('_TITLE',utf8_encode('Título'));
...
define('_UBICATION',utf8_encode('Ubicación'));
...
define('_USERINFO',utf8_encode('Información de usuario'));

...
getware.ui.content={
  ...
  ******************/
  ...
  for(i=0;i<json.type.length;i++){
   ...
   output+='<td class="subtitle dialog-subtitle" valign="top" align="left">'+json.name[i]+'</td>';
   output+='<td id="img'+row+'" width="16" valign="top"><div>&nbsp;</div></td>';
   output+='<td valign="top" align="left">';
   var value='';
   if(json.data) value=json.data[i];
   if(json.type[i]=='date')
    output+='<input id="'+row+'date'+date+'" name="'+row+date+'" class="dialog-input" type="text" size="10" maxlength="10" value="'+value+'" datepicker="'+json.type[i]+'" />';
   if(json.type[i]=='month')
    output+='<input id="'+row+'date'+date+'" name="'+row+date+'" class="dialog-input" type="text" size="10" maxlength="10" value="'+value+'" datepicker="'+json.type[i]+'" />';
   if(json.type[i]=='year')
    output+='<input id="'+row+'date'+date+'" name="'+row+date+'" class="dialog-input" type="text" size="10" maxlength="10" value="'+value+'" datepicker="'+json.type[i]+'" />';
   if(json.type[i]=='view')
    output+='<input id="'+row+'"             name="'+row+'"      class="dialog-input" type="text" size="25" maxlength="255" value="'+value+'" view="'+json.type[i]+'" />';
   ...
   if(json.type[i]=='varchar')
    output+='<input id="'+row+'" name="'+row+'" class="dialog-input" type="text" size="25" maxlength="255" value="'+value+'" />';
   if(json.type[i]=='pass')
    output+='<input id="'+row+'" name="'+row+'" class="dialog-input" type="password" size="25" maxlength="255" value="" />';
   if(json.type[i]=='text')
    output+='<textarea id="'+row+'" name="'+row+'" class="dialog-input" wrap="on" cols="22" rows="7">'+value+'</textarea>';
   output+='</td></tr></table>';
   row++;
   rest++;
  }
  ...
  ******************/
  ...
  for(i=0;i<json.type.length;i++){
   ...
   if(json.type[i]=='date')
    output+='<input id="'+row+'date'+date+'" name="'+row+'" class="dialog-input" type="text" size="10" maxlength="10" value="'+value+'" datepicker="'+json.type[i]+'" />'+info;
   if(json.type[i]=='month')
    output+='<input id="'+row+'date'+date+'" name="'+row+'" class="dialog-input" type="text" size="10" maxlength="10" value="'+value+'" datepicker="'+json.type[i]+'" />'+info;
   if(json.type[i]=='year')
    output+='<input id="'+row+'date'+date+'" name="'+row+'" class="dialog-input" type="text" size="10" maxlength="10" value="'+value+'" datepicker="'+json.type[i]+'" />+info';
   if(json.type[i]=='view')
    output+='<input id="'+row+'" name="'+row+'" class="dialog-input" type="text" size="25" maxlength="255" class="view" value="'+value+'" view="'+json.type[i]+'" />&nbsp;<img id="ximage'+row+'" src="images/view.png" title="Ver" onclick="javascript:getware.ui.submenu.get(\''+date+'\',\''+row+'\',\''+json.module+'\',\'\');" />'+info;
   if(json.type[i]=='varchar')
    output+='<input id="'+row+'" name="'+row+'" class="dialog-input" type="text" size="25" maxlength="255" value="'+value+'" />'+info;
   if(json.type[i]=='pass')
    output+='<input id="'+row+'" name="'+row+'" class="dialog-input" type="password" size="25" maxlength="255" value="" />'+info;
   if(json.type[i]=='text')
    output+='<textarea id="'+row+'" name="'+row+'" class="dialog-input" wrap="on" cols="22" rows="7">'+value+'</textarea>'+info;
   output+='</td></tr></table>';
   row++;
   rest++;
  }
  ...
  ******************/
  ...
  for(i=0;i<json.name.length&&head>row;i++){
   ...
   if(json.type[i]=='text'){
   	output+='</tr></table>'
   	output+='<table cellspacing="1" cellpadding="1"><tr class="list_even">';
   	output+='<textarea id="'+row+'x" name="'+row+'x" class="dialog-input" placeholder="'+json.name[i]+'" wrap="on" style="width:98%;height:150px;">'+value+'</textarea>';
   	output+='</tr></table>'
   	output+='<table cellspacing="1" cellpadding="1"><tr class="list_even">';
   }
   ...
   if(json.type[i]=='date') output+='class="dialog-input" type="text" maxlength="10" class="date" value="'+value+'" datepicker="'+json.type[i]+'" />';
   if(json.type[i]=='year') output+='class="dialog-input" type="text" maxlength="10" class="date" value="'+value+'" datepicker="'+json.type[i]+'" />';
   if(json.type[i]=='view') output+='class="dialog-input" type="text" maxlength="255" class="view" value="'+value+'" view="'+json.type[i]+'" />&nbsp;<img id="ximage'+row+'x" src="images/view.png" title="Ver" onclick="javascript:getware.ui.submenu.get(\''+date+'\',\''+row+'x\',\''+json.module+'\',\'\');">';
   if(json.type[i]=='varchar') output+='class="dialog-input" type="text" maxlength="255" class="normal" value="'+value+'" />';
   if(json.type[i]=='pass') output+='class="dialog-input" type="password" maxlength="255" class="normal" value="" />';
   if(json.type[i]=='check') output+='class="dialog-input" type="checkbox" value="'+value+'" onclick="javascript:if(this.checked==true) this.value=\'SI\'; else this.value=\'NO\';" />';
  ...
  for(i=head;i<json.name.length;i++){
   ...
   if(json.type[i]=='file')
    getware.ui.content.aff.inner+='class="dialog-input" type="file" value="'+value+'" />';
   if(json.type[i]=='date')
    getware.ui.content.aff.inner+='class="dialog-input" type="text" maxlength="10" class="date" value="'+value+'" ondblclick="javascript:getware.ui.content.aff.dblclick('+date+',\''+row+'xIDx\');" datepicker="'+json.type[i]+'" />';
   if(json.type[i]=='year')
    getware.ui.content.aff.inner+='class="dialog-input" type="text" maxlength="10" class="date" value="'+value+'" ondblclick="javascript:getware.ui.content.aff.dblclick('+date+',\''+row+'xIDx\');" datepicker="'+json.type[i]+'" />';
   if(json.type[i]=='view'){
    getware.ui.content.aff.inner+='class="dialog-input" type="text" maxlength="255" class="view" value="'+value+'" filter="'+json.filter[i]+'" ondblclick="javascript:getware.ui.content.aff.dblclick('+date+',\''+row+'xIDx\');" view="'+json.type[i]+'" />';
   }
   if(json.type[i]=='varchar')
    getware.ui.content.aff.inner+='class="dialog-input" type="text" maxlength="255" class="normal" value="'+value+'" ondblclick="javascript:getware.ui.content.aff.dblclick('+date+',\''+row+'xIDx\');" />';
   if(json.type[i]=='pass')
    getware.ui.content.aff.inner+='class="dialog-input" type="password" maxlength="255" class="normal" value="" />';
   ...
   if(json.type[i]=='text')
    getware.ui.content.aff.inner+='<input id="'+row+'xIDx" name="'+row+'xIDx" class="dialog-input" type="text" maxlength="255" class="normal" value="'+value+'" ondblclick="javascript:getware.ui.content.aff.dblclick('+date+',\''+row+'xIDx\');" />';

   if(json.type[i]=='textbox')
   	getware.ui.content.aff.inner+='<textarea id="'+row+'xIDx" name="'+row+'xIDx" class="dialog-input" placeholder="'+json.name[i]+'" wrap="on" style="width:98%;height:50px;" ondblclick="javascript:getware.ui.content.aff.dblclick('+date+',\''+row+'xIDx\');">'+value+'</textarea>';

   if(json.type[i]=='check')
    getware.ui.content.aff.inner+='<input id="'+row+'xIDx" name="'+row+'xIDx" class="dialog-input" type="checkbox" value="'+value+'" onclick="javascript:if(this.checked==true) this.value=\'SI\'; else this.value=\'NO\';" />';
  ...
  ******************/
  ...
  for(i=0;i<json.name.length&&head>row;i++){
   ...
   if(json.type[i]=='date') output+='class="dialog-input" type="text" maxlength="10" class="date" value="'+value+'" datepicker="'+json.type[i]+'" />';
   if(json.type[i]=='year') output+='class="dialog-input" type="text" maxlength="10" class="date" value="'+value+'" datepicker="'+json.type[i]+'" />';
   if(json.type[i]=='view') output+='class="dialog-input" type="text" maxlength="255" class="view" value="'+value+'" view="'+json.type[i]+'" />';
   if(json.type[i]=='varchar') output+='class="dialog-input" type="text" maxlength="255" class="normal" value="'+value+'" />';
   if(json.type[i]=='pass') output+='class="dialog-input" type="password" maxlength="255" class="normal" value="" />';
   if(json.type[i]=='check') output+='class="dialog-input" type="checkbox" value="'+value+'" onclick="javascript:if(this.checked==true) this.value=\'SI\'; else this.value=\'NO\';" />';
  ...
  for(i=head;i<json.name.length;i++){
   ...
   if(json.type[i]=='year')
    getware.ui.content.aff.inner+='class="dialog-input" type="text" maxlength="10" class="date" value="'+value+'" ondblclick="javascript:getware.ui.content.aff.dblclick('+date+',\''+row+'xIDx\');" datepicker="'+json.type[i]+'" />';
   if(json.type[i]=='view')
    getware.ui.content.aff.inner+='class="dialog-input" type="text" maxlength="255" class="view" value="'+value+'" ondblclick="javascript:getware.ui.content.aff.dblclick('+date+',\''+row+'xIDx\');" view="'+json.type[i]+'" filter="'+json.filter[i]+'" />';
   if(json.type[i]=='varchar')
    getware.ui.content.aff.inner+='class="dialog-input" type="text" maxlength="255" class="view" value="'+value+'" ondblclick="javascript:getware.ui.content.aff.dblclick('+date+',\''+row+'xIDx\');" normal="'+json.type[i]+'"/>';
   if(json.type[i]=='pass')
    getware.ui.content.aff.inner+='class="dialog-input" type="password" maxlength="255" class="normal" value="" />';
